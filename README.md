...
[Создание виртуального окружения проекта на VPS-сервере](linux/bot-deploy-to-vps.md#создание-виртуального-окружения-проекта-на-vps-сервере)  
...
[FastAPI](python/fastapi.md#fastapi)  
