...
#### SQLite3
[Создание базы данных SQLite](create_sqlite_database.md#создание-базы-данных-sqlite) | [SQL — основные команды](create_sqlite_database.md#sql--основные-команды)

## Проекты
#### Новый проект
[Создание виртуального окружения для проекта на компьютере](create_new_python_project.md#создание-виртуального-окружения-для-проекта-на-компьютере) | [Создание git в проекте (Python)](../git/creating_git_in_project.md#создание-git-в-проекте-python)
